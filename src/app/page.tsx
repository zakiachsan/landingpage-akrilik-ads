          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left space-y-6">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-[1.15]">
                Buat Pengumuman Kantor Terlihat{" "}
                <span className="text-blue-400">Profesional & Premium</span>
              </h1>
              <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-lg">
                Frame akrilik premium untuk kantor, hotel, rumah sakit, dan area publik. Rapi, tahan lama, dan siap kirim cepat.
              </p>
      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 mb-3">
            Kenapa Banyak Pengumuman Terlihat{" "}
            <span className="text-red-500">Tidak Profesional?</span>
          </h2>
